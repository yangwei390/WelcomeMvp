...
public class MuPDFActivity extends Activity implements FilePicker.FilePickerSupport
{
	...
	private MuPDFCore openFile(String path,String title,String soPath)
	{
...
//			byte buffer[] = null;
			String title = intent.getStringExtra("pdf_title");
			String filePath = intent.getStringExtra("file_path");
			String soPath = intent.getStringExtra("so_path");
			core = openFile(filePath,title,soPath);

...
//	}
	...
	private static boolean IS_SO_LOAD = false;

	static void LoadSo(String soPath){
		if(!IS_SO_LOAD){
            try{
                System.load(soPath);
            }catch(Exception e){
	...
	public MuPDFCore(Context context, String filename,String soPath) throws Exception
	{
		LoadSo(soPath);
	...
	public MuPDFCore(Context context, byte buffer[], String magic,String soPath) throws Exception {
		LoadSo(soPath);
		fileBuffer = buffer;

package com.yangwei.www.view.pickerview.pickerview.view;

import android.view.View;

import com.yangwei.www.R;
import com.yangwei.www.view.pickerview.pickerview.adapter.ArrayWheelAdapter;
import com.yangwei.www.view.pickerview.pickerview.adapter.NumericWheelAdapter;
import com.yangwei.www.view.pickerview.pickerview.listener.ISelectTimeCallback;
import com.yangwei.www.view.pickerview.pickerview.utils.ChinaDate;
import com.yangwei.www.view.pickerview.pickerview.utils.LunarCalendar;
import com.yangwei.www.view.pickerview.wheelview.listener.OnItemSelectedListener;
import com.yangwei.www.view.pickerview.wheelview.view.WheelView;
...
public class WheelTime {
     ...
     * @param s
     */
    private void setSolar(final int year, final int month, final int day, int h, int m, int s) {
...
//                maxItem = endD;
    ...
    public String getTime() {
        ...
        int minute = wv_minutes.getCurrentItem();
            ...
            if ((wv_month.getCurrentItem() + startMonth) == startMonth) {
                ...
                if ((wv_day.getCurrentItem() + startDay) == startDay) {
                    ...
                    if ((wv_hours.getCurrentItem() + startHour) == startHour) {
                        minute = wv_minutes.getCurrentItem() + startMinute;
                    }
                }
            }
        }

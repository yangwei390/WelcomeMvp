...
public class CustomLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (childCount == 2) {
            ...
            if (getChildAt(0) instanceof TextView) {
                ...
                initTextParams(tv, tv.getText(), tv.getMeasuredWidth(), tv.getPaint(), tv.getLineSpacingExtra());
            } else {
     ...
     */
    private void initTextParams(TextView tv, CharSequence text, int maxWidth, TextPaint paint, float mSpacingAdd) {
//        int width =
//        ,tv.getEllipsize(),(tv.getWidth() - tv.getCompoundPaddingLeft() - tv.getCompoundPaddingRight()
//        StaticLayout staticLayout = new StaticLayout(text, paint, maxWidth, Layout.Alignment.ALIGN_NORMAL, 1.0f, mSpacingAdd, false);
        StaticLayout staticLayout = new StaticLayout(text, 0, text.length(), paint, maxWidth, Layout.Alignment.ALIGN_NORMAL, 1.0f, mSpacingAdd, false, TextUtils.TruncateAt.END, 200);
